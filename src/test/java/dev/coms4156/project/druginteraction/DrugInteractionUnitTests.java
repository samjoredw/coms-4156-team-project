...
class DrugInteractionUnitTests {
  ...
  void testMainMethod() {
    ...
    try (MockedStatic<SpringApplication> mockStaticSpringApplication
                 = mockStatic(SpringApplication.class)) {
      mockStaticSpringApplication.when(() -> SpringApplication.run(
              DrugInteraction.class, new String[] {}))
      ...
      mockStaticSpringApplication.verify(() -> SpringApplication.run(
              DrugInteraction.class, new String[] {}));
